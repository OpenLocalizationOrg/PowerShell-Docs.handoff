...
**Ein Modul mit Abhängigkeiten zu installieren:**
```powershell
PS C:\\windows\\system32&gt; Get-InstalledModule
...
**Inhalt der ModuleWithDependencies2 Modul Manifestdatei an:**
```powershell
@{
...
**Beispiele für die Update-Module:**
```powershell
...
**Beispiele für die Veröffentlichung-Module:**
```powershell
